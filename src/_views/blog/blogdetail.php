            ...
            <div class="wrap_container">
                <div class="row">
                    ...
                    <div class="col-lg-8 blog_detail">
                        <!-- Blog Detail Content -->
                        <div class="row mb-5">
                            <h3 class="text-uppercase mb-2" style="white-space: nowrap; font-weight: 600; font-size: 20rem;">Best LearnPress WordPress Theme Collection For 2024</h3>
                            <!-- Begin Author,Date -->
                            <div class="col-lg-12 d-flex">
                                <div class="mb-3 mr-3">
                                    <i class="fa-solid fa-user" style="color: orange;"></i>
                                    <span class="author_name text-muted"></span>
                                </div>
                                <div class="mb-3 mr-3">
                                    <i class="fa-regular fa-calendar" style="color: orange;"></i>
                                    <span class="date_created text-muted"></span>
                                </div>
                                <div class="mb-3 mr-3">
                            ...
                            <div class="col-lg-12 mb-5">
                                <img class="img-fluid img-blog mb-3 mb-md-0" style="max-width: 50%; border-radius: 2rem;" src="/assets/images/blog.png" alt="">
                            ...
                            <!-- Begin Share -->
                            <div class="col-lg-4" style="font-size: 15rem;color:#00ff00">
                                Share:
...
<!-- End Pagination tags ralative -->
                            ...
                            <div class="comment col-lg-12 mt-5">
                                <h3 class="text-uppercase mb-4" style="font-weight: 600; font-size: 20rem; color:orange">Comments</h3>
                                <h4 class="mb-4" style="font-weight: 300; font-size: 15rem">
                                    <span>Comments</span>
                                </h4>
                                <hr>
...
<!-- End Pagination -->
                        ...
                        <div class="col-12 mt-5 form-cmt">
                            ...
                            <p class="text-muted" style="color:red">Your email address will not be published. Required fields are marked *</p>
                            <form action="">
                    ...
                    <div class="other_content col-lg-4 mt-5">
                        ...
                        <div class="mb-5 category-list">
                            <h3 class="text-uppercase mb-4" style="font-weight: 600; font-size: 20rem; color:orange">Categories</h3>
                        ...
                        <div class="mb-5 recent-post">
                            <h3 class="text-uppercase mb-4" style="font-size: 20rem; font-weight:600; color:orange">Recent Post</h3>
                        ...
                        <!-- Tag Cloud -->
                        <div class="mb-5 tags">
                            <h3 class="text-uppercase mb-4" style="color: orange">Tags</h3>
