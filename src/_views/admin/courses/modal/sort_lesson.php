                ...
                <div class="row" id="parent-div" data-plugin="dragula" data-containers="[&quot;section-list&quot;]">
                    <div class="col-md-12">
                        <div class="bg-dragula p-2 p-lg-4">
                            <h5 class="mt-0">Danh sách bài giảng <button type="button" class="btn btn-outline-primary btn-sm btn-rounded alignToTitle" id="section-sort-btn" onclick="sort()" name="button">Sắp xếp</button>
                            </h5>
