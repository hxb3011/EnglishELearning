                                            ...
                                            <? if($this->posts != null): ?>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><? echo ($post->name) ?></td>
                                                        <td><? echo ($post->tutorName) ?></td>
                                                        <td>
                                                            Ngày bắt đầu : <? echo ($post->beginDate->format('d-m-Y')); ?>
                                                            <br />
                                                            Ngày kết thúc : <? echo ($post->endDate->format('d-m-Y')); ?>
                                                        </td>
                                                        <td>
                                                            <? if ($post->state == 1) : ?>
                                                        ...
                                                        <td>
                                                            <span class="badge text-bg-secondary"><? echo ($post->price); ?> VNĐ</span>
                                                        </td>
                                                        <td>
                                                            <div class="dropright">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <li><a class="dropdown-item" href="/courses/detail.php/<?echo $post->id?>" target="_blank">Xem khóa học</a></li>
                                                                    <li><a class="dropdown-item" href="/administration/courses/edit.php?courseId=<?echo $post->id?>">Sửa khóa học</a></li>
