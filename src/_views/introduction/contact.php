...
final class ContactPage extends BaseHTMLDocumentPage
{
    ...
    {
        parent::documentInfo($author, $description, "Liên hệ - " . $title);
    }

    public function openGraphInfo(string $image, string $description, string $title)
    {
        parent::openGraphInfo($image, $description, "Liên hệ - " . $title);
    }
    ...
    {
        $this->styles(
            "/clients/css/contact/contact.css"
        );
        // $this->scripts(
