<?php
$title = "Blog - Hệ thống học tiếng anh Vocala";
$activeNav = "blog";
require_once(APP_ROOT . "/content/views/components/header.php");
?>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
<link rel="stylesheet" href="/public/css/blog/bloglist.css">
            ...
            <div class="col-lg-8">
                ...
                <div class="col pb-3">
                    <div class="row-md-6 mb-4">
                        <div class="row g-0">
                            <div class="col-md-6">
                                <img class="img-fluid img-blog mb-3 mb-md-0" style="width: 100%" src="/public/images/blog.png" alt="">
                            </div>
                            <div class="col-md-6">
