<?php 
    $title = "Blog-Detail - Hệ thống học tiếng anh Vocala";
    require('./components/header.php') 
?>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
    <link rel="stylesheet" href="../../public/css/blog/blogdetail.css">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg-12 mb-5">
                            <img class="img-fluid img-blog mb-3 mb-md-0" style="width: 100%; border-radius: 2rem;" src="../../public/images/blog.png" alt="">
                        ...
                        <div class="comment col-lg-12 mt-5">
                            ...
                            <div class="media row mb-4">
                                <img class="col-md-3 mr-3" src="../../public/images/blog4.png" alt="user image" style="width: 100px;">
                ...
                <div class="col-lg-4 mt-5">
                    ...
                    <div class="mb-5 recent-post">
                        ...
                        <a class="d-flex align-items-center text-decoration-none mb-3" href="">
                            <img class="img-fluid rounded" src="../../public/images/blog4.png" alt="wordpress image" style="max-width: 50%;">
                            <div class="pl-3">
