...
<head>
    ...
    <link rel="stylesheet" href="/englishelearning/src/public/css/home/home_main.css">
    <link rel="icon" type="image/x-icon" href="/englishelearning/src/public/images/logo-icon.png">
    <link rel="stylesheet" href="/englishelearning/src/public/css/header/header.css">
</head>
    ...
    <div class="header">
        ...
        <!-- <div class="navigation">
            <div class="container">
                <?php
                    echo "<ul>";
                    echo "<li><a href='/englishelearning/src/content/views/home.php' class='nav-link'>Home </a></li>";
                    if ($currentPage != 'home'){
                        echo " > ";
                    }
                    if ($currentPage == 'bloglist'){
                        echo "<li><a href='/englishelearning/src/content/views/bloglist.php' class='nav-link'>Blog </a></li>";
                    }
                ?>
            </div>
        </div> -->
